  ...
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)]">
      <aside className="w-72 flex-shrink-0 border-r border-brand-border bg-white pt-6 overflow-y-auto">
        ...
        <button className="flex items-center gap-2 w-full px-5 py-2 text-sm font-semibold text-dessa-teal hover:bg-dessa-tealLight transition-colors">
          <Plus size={14} />
          Add Students
        </button>
        ...
        <div className="flex flex-col">
          {CLASS_ROSTER.map((name) => (
            <div key={name} className="flex items-center gap-3 px-5 py-2 text-sm text-brand-text">

// Concept A — Original (2026-09-23) — the report as it exists in prod today:
// single-week snapshot, collapsible Filters bar, sortable Total
// Users/Reached Goal/Engagement % table. Restored verbatim from commit
// 0446d58 (pre-dates the "positive, window-based framing" restructure) so
// Concept B has a real baseline to be compared against, not a replacement
// for it. Selected via Nav's Site Engagement concept switcher — see
...
export default function Report2ConceptA() {

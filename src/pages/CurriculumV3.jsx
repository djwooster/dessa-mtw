...
export default function CurriculumV3({
  enrolledCourse,
  hideUnenrolled,
  bookmarkedLessons = [],
  onEnroll,
  ...
  const handleEnroll = (course) => {
    onEnroll(course)
    navigate('/mtw3/lesson', { state: { course } })
  }
                      ...
                      <div className="py-1">
                        {bookmarkedLessons.map((bm, i) => (
                          <button
                            ...
                            onClick={() => {
                              navigate('/mtw3/lesson', { state: { course: bm.course } })
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    {filtered.map((course, i) => (
                      <CourseCard
                        ...
                        onContinue={() => navigate('/mtw3/lesson', { state: { course: enrolledCourse } })}
